    ...
    <div class="mx-auto md:w-8/12 lg:w-8/12 mt-8">
        <div class=" bg-white text-app-text rounded-lg p-8">
            <div class="mb-8">
                ...
                Entscheidung teilzunehmen. Wir bieten Ihnen eine benutzerfreundliche und sichere Umgebung, um Ihre Wahl
                zu
                ...
                Nutzen Sie diese Gelegenheit, um Ihre Überzeugungen und Interessen zu vertreten. Ihre Stimme ist wichtig
                und
                ...
                Gemeinsam können wir positive Veränderungen bewirken und eine starke demokratische Gesellschaft
                aufbauen.<br>
                Vielen
